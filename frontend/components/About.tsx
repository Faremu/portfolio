                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="my-3">
                            ...
                            <div className="flex flex-row space-x-2">
                                <a href="https://www.linkedin.com/in/kritsanapong-tongjai-a213b0279/" target="_blank"><i className="linkedin-icon"></i></a>
                                <a href="https://github.com/Faremu" target="_blank"><i className="github-icon"></i></a>
                                <a href="https://www.hackerrank.com/profile/kritsanapong_to1" target="_blank"><i className="hackerrank-icon"></i></a>
